...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative bg-gradient-to-br from-emerald-50 via-green-50 to-lime-50 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Fresh <span className="text-emerald-600">Peppers</span> & <span className="text-red-500">Tomatoes</span>
            <br />
            <span className="text-3xl md:text-5xl text-gray-700">From Shaki, Oyo State</span>
          </h1>
